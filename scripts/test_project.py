...
def main():
    parser = argparse.ArgumentParser(description='Проверка QadamSupply без ключей AI и изменения рабочих данных')
    ...
    print('QadamSupply: ' + ('полный прогон с двумя архивами' if args.iek_zip else 'быстрый прогон; ZIP-тесты будут пропущены'), flush=True)
